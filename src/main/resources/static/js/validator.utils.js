(function ($) {
    ...
    /*
    $.validator.addMethod("money",function (value,ele) {
        if(value == nu)
    },"金额为1 - 99999999 元之间")
    */
    ...
    $.validator.addMethod("phone",function (value,ele) {
        return (/^1(3|4|5|7|8)\d{9}$/.test(value));
    },"请输入有效手机号码")
    
    
    $.validator.addMethod("chineseName",function (value,ele) {
        return /^([\u2E80-\u9FFF]{2,})$/.test(value);
